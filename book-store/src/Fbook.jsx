		...
		<div className="book">
			<div className="front">
				<div className="cover">
                    ...
                    <p className="num-down">1</p>
                    <p className="author">Haruki Murakami
</p>
				</div>
			</div>
			<div className="left-side">
				<h2>
					<span>Haruki Murakami
</span>
					<span>1984</span>
				</h2>
			</div>
